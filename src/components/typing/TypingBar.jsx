...
const TypingBar = () => {
  ...
  useEffect(() => {
    if (!scriptsAdded.current) {
      ...
      element.onload =()=>{
        ...
        // scriptKeyboardJs.onLoad(()=>{
          var userId = "66c0bf72816fcc681675bac8"
          var userSeconds = 0;
    ...
    return gen;
        ...
        // state variables
        var bar = user.bar;
        var time = user.typingTime;
        var typingContent = user.typingContent;
        var typingSource = user.typingSource;
        ...
        async function saveTestInfo(measurments, words, bar, time, typingContent, typingSource, averageWpm, averageRaw, accuracy){
            await fetchApi("/typing/saveTestInfo", "POST", {userid: user._id, measurments, words, bar, time, typingContent, typingSource, averageWpm, averageRaw, accuracy}, (success, res)=>{
              if(!success){
                alert(res);
              }
            })
      ...
      {/* <div className="typingMenu">
        ...
        <div className="menuItem" position="bottom">
          ...
          <div className="menuItemContent">
            ...
            <li name="tmin" data-title="120sec">120s</li>
            </ul>
          </div>
        </div>
