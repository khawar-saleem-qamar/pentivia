    ...
    // if(updatedString == ""){
      useEffect(() => {
        ...
        return gen;
            ...
            var monkeyTypingBar;
            var monkeyBarContent
            if(bar == "monkey"){
              monkeyTypingBar = document.querySelector("[uid=typingBar]");
              monkeyBarContent = monkeyTypingBar.querySelector("[uid=content]");
            ...
            var barContent;
            var sidewayCarot;
            var contentLeftSidewayBar;
            var contentRightSidewayBar
            if(bar == "chat"){
              typingBar = document.getElementById("sidewayTypingBar");
              barContent = typingBar.querySelector("[uid=content]");

              const colorWords = document.querySelector("#colorWordsWrapper #colorWords")
              sidewayCarot = document.querySelector("#sidewayTypingBar [uid=content] #sidewayCarrot");
              contentLeftSidewayBar = document.querySelector("#sidewayTypingBar [uid=content] .contentLeft");
              contentRightSidewayBar = document.querySelector("#sidewayTypingBar [uid=content] .contentRight");
            }
